...
function renderNavbar(usuario) {
    ...
    if (usuario && usuario.role === 'estudiante') {
        roleLinks = `
            <li class="nav-item">
                <a class="nav-link" href="/modules/autoevaluacion/autoevaluacion.html" title="Evalúa tu estado emocional">
        ...
        sessionLink = `
            <li class="nav-item dropdown d-flex align-items-center">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                    <li><a class="dropdown-item" href="/login/editarPerfil.html">
