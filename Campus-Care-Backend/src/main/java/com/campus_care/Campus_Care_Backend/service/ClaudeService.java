...
public interface ClaudeService {
    ...
    List<ClaudeServiceImpl.RecomendacionInterna> refinarRecomendacion(Autoevaluacion autoevaluacion, List<Recursos> candidatos, String contextoDiario, String catalogoEjercicios);
